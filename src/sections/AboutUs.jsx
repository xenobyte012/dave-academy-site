...
function AboutUs() {
  return (
    <section id="about" className="bg-background-1 normal-text-2 py-16 px-6">
      <div className="max-w-7xl mx-auto">

        {/* Heading */}
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-4xl font-bold text-heading-1 mb-4">
            About Us
          </h1>
          <p className="max-w-2xl mx-auto text-sm md:text-base text-sub-heading-1">
            We don’t just teach — we build confidence, clarity, and real academic growth.
          </p>
        </div>

        {/* Content */}
        <div className="grid lg:grid-cols-2 gap-12 items-center text-normal-text-1">
          
          {/* LEFT: Text */}
          <div className="text-left max-w-xl mx-auto lg:mx-0">
            <h2 className="text-2xl font-semibold mb-6 text-sub-heading-1">
            ...
            <p className="mb-4 leading-relaxed ">
              At <span className="font-semibold text-slate-900">St Dave Academy</span>, 
